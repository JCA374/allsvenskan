...
def validate_implementation() -> Dict:
    ...
    try:
        ...
        from allsvenskan.data.odds_strength_extractor import OddsStrengthExtractor
        extractor = OddsStrengthExtractor()
        validation_results['odds_extractor_available'] = True
        
        # Test adaptive calculator
        from allsvenskan.data.odds_strength_extractor import AdaptiveStrengthCalculator
        adaptive_calc = AdaptiveStrengthCalculator()
        validation_results['adaptive_calculator_available'] = True
        
        # Test integration function
        from allsvenskan.data.odds_strength_extractor import integrate_odds_strengths_with_historical
